...
router.post('/invitations/preview', allowUserOrInternalService, validateRequest({ body: invitationTokenBodySchema }), ctrl.previewInvitation);
router.post('/invitations/accept', allowUserOrInternalService, validateRequest({ body: invitationTokenBodySchema }), ctrl.acceptInvitation);
...
router.post('/:id/invitations', allowUserOrInternalService, validateRequest({ body: createInvitationBodySchema }), ctrl.createInvitation);
