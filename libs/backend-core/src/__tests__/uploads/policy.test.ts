...
describe('upload policy', () => {
  it.each([
    ...
    ['bundle.tar.gz', 'application/x-compressed-tar', 'gzip', 10 * 1024 ** 3],
    ['bundle.tgz', 'application/x-compressed', 'gzip', 10 * 1024 ** 3],
    ['bundle.tar', 'application/x-gtar', 'tar', 10 * 1024 ** 3],
